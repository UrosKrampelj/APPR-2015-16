...
S spletnega naslova https://en.m.wikipedia.org/wiki/List_of_Chelsea_F.C._players#List_of_players sem uvozil tabelo igralcev v obliki HTML, v kateri je za vsakega igralca podano :
      ...
      leta, v katerih je nastopal za klub
...
Nato sem s spletnega naslova https://en.wikipedia.org/wiki/List_of_Chelsea_F.C._seasons uvozil tabelo uvrstitev kluba v raličnih tekmovanjih, v kateri je po sezonah podano:
      liga, v kateri je klub nastopal
      
      število zmag
      
      število neodločenih tekem
      
      število porazov
      
      število zadetih golov
      
      število prejetih golov
      
      točke
      
      nejboljši strelec kluba
      
      število zadetih golov najbolšega strelca
      
      
      
Cilj projekta je ugotoviti, katerim nogometašem se je s svojimi nastopi uspelo zapisati z v klubsko zgodovino kot legende kluba in ugotoviti, katere sezone so bile bolj ali manj uspešne glede na končno uvrstitev v prvenstvu.
